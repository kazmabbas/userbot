                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @V_P_N_8 \
                                  \n\n--------بـدء تتبـع سجـل القائد 𝗟𝗲𝗔𝗱𝗘𝗿𓅯𖤊--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع القائد 𝗟𝗲𝗔𝗱𝗘𝗿𓅯𖤊--------"
                        ...
                        link = "[yousef(https://t.me/V_P_N_8 )"
                        text = (
                            "**✘ تقـريـر إشعـار القائد 𝗟𝗲𝗔𝗱𝗘𝗿𓅯𖤊 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار القائد 𝗟𝗲𝗔𝗱𝗘𝗿𓅯𖤊 ✘**\n\n "
                        link = "[𝗟𝗲𝗔𝗱𝗘𝗿𓅯(https://t.me/V_P_N_8 )"
