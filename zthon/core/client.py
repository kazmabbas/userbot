                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @M_4_R_0 \
                                  \n\n--------بـدء تتبـع سجـل مارو ✘𓆩𝗠𝗔𝗥𝗢𖠲𓆪 ™𝗔𝗜𝗕𝗥𝗔𝗭 i𝗜 ⃝🇧🇷➼💎--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع مارو ✘𓆩𝗠𝗔𝗥𝗢𖠲𓆪 ™𝗔𝗜𝗕𝗥𝗔𝗭 i𝗜 ⃝🇧🇷➼💎--------"
                        ...
                        link = "[yousef(https://t.me/M_4_R_0 )"
                        text = (
                            "**✘ تقـريـر إشعـار مارو ✘𓆩𝗠𝗔𝗥𝗢𖠲𓆪 ™𝗔𝗜𝗕𝗥𝗔𝗭 i𝗜 ⃝🇧🇷➼💎 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار مارو ✘𓆩𝗠𝗔𝗥𝗢𖠲𓆪 ™𝗔𝗜𝗕𝗥𝗔𝗭 i𝗜 ⃝🇧🇷➼💎 ✘**\n\n "
                        link = "[𝗟𝗲𝗔𝗱𝗘𝗿𓅯(https://t.me/M_4_R_0 )"
