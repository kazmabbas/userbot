                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل ريبيثون 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 --------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ريبيثون 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 --------"
                        ...
                        text = (
                            "**✘ تقـريـر إشعـار ريبيثون 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘  ✘**\n\n"
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  \n\nنسجل فقـط تقريـر الإشعـار وتـاريخـه ،\
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @EEc5e\
                                  \n\n--------بـدء تتبـع سجـل ريبيثون 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 --------\
                                  \n- التـاريـخ : {date}\n- ايـدي الكـروب : {str(check.chat_id)}\
                                  \n- ايـدي الشخـص : {str(check.sender_id)}\
                                  \n- رابـط الرسـالـه : {await check.client.get_msg_link(check)}\
                        ...
                        text = "**✘ تقـريـر إشعـار ريبيثون 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘  ✘**\n\n "
                        link = "[𝗧𝗢𝗙𝗘𝗬](https://t.me/EEc5e)"
