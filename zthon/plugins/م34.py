...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 - اوامر بوت استخراج الجلسات](t.me/Repethone) 𓆪\n\n"
    "⪼ بوت استخراج جلسات الخاص بسورس ريبيثون \n"
    "⪼(@rev_m_1bot)n"
    "⪼ ⪼ برعاية المطور توفي \n"
    "\n𓆩 [𝗧𝗢𝗙𝗘𝗬](t.me/EEc5e) 𓆪"
)
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 :**\n\n"
