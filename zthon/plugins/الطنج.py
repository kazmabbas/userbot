...
ZORDR = gvarstatus("Z_ORDR") or ".."
ZLORDR = gvarstatus("Z_LORDR") or ".."
...
async def zed_handler(event):
    ...
    query = event.text
    await zedub.get_me()
    if query.startswith("..") and event.query.user_id == zedub.uid:
...
async def repozedub(event):
    ...
    response = await event.client.inline_query(Config.TG_BOT_USERNAME, ".")
...
async def zed_handler(event):
    ...
    if query.startswith("يوسف") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("سورس ريفز العربي - 𝙍𝙀𝙁𝙕 𝙐𝙎𝙀𝙍𝘽𝙊𝙏", "https://t.me/def_Zoka"),],[Button.url("المطور2", "https://t.me/Q_2_Q_Y"), Button.url("الفـارات", "https://t.me/KALAYISH"),],[Button.url("الشـروحـات¹", "https://t.me/def_Zoka"),],[Button.url("كــلايــش ريفز", "https://t.me/KALAYISH"),],[Button.url("مطـور السـورس", "https://t.me/IC_X_K"),]]
...
async def repozedub(event):
    ...
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zedub.inline_query(TG_BOT, "يوسف")
    await response[0].click(event.chat_id)
    await event.delete()
...
async def repozedub(event):
    ...
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zedub.inline_query(TG_BOT, "..")
    await response[0].click(event.chat_id)
    await event.delete()
