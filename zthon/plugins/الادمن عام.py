...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 5904390523 or user.id == 5593884330 or user.id == 6294853381:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 5904390523 or user.id == 6294853381 or user.id == 5593884330:
...
async def catgkick(event):  # sourcery no-metrics
    ...
    if user.id == 6294853381 or user.id == 5904390523 or user.id == 5578760481:
