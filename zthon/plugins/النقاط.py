...
ZelzalCoins_cmd = (
    "[ᯓ 𝘀𝗼𝘂𝗿𝗰𝗲 𝐑𝐄𝐅𝐙 - اوامـر تجميـع النقـاط](t.me/def_Zoka) 𓆪\n\n"
    "**𓆰 قـائمـة اوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس ريفز🦾 :** \n\n"
    "`.المليار`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**@IC_X_K ضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @IC_X_K**"
)
...
zedub.zed_cmd(pattern="تجميع دعمكم ?(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**𓆰 حـسنـًا .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @DamKombot**")
