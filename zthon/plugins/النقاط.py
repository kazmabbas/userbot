...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗟𝗘𝗮𝗗𝗲𝗥 - اوامـر تجميـع النقـاط](t.me/V_P_N_8) 𓆪\n\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. اذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @DAD_E3DAM**"
)
...
async def _(event):
    ...
    for i in range(100):
        ...
        if msgs.message.find('**⎉╎لا يوجد قنوات في الوقت الحالي .. قم يتجميع النقاط بطريقه مختلفه**') != -1:
            ...
            break
        if con == "ايقاف": #Code by T.me/DAD_E3DAM
