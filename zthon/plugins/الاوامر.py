...
async def zed_handler(event):
    ...
    if query.startswith("ريفز") and event.query.user_id == zedub.uid:
        ...
        buttons = [[Button.url("سورس ريفز العربي - 𝙍𝙀𝙁𝙕 𝙐𝙎𝙀𝙍𝘽𝙊𝙏", "https://t.me/def_Zoka"),],[Button.url("المطور2", "https://t.me/U_U_X_M"), Button.url("الفـارات", "https://t.me/KALAYISH"),],[Button.url("الشـروحـات¹", "https://t.me/def_Zoka"),],[Button.url("كــلايــش ريفز", "https://t.me/KALAYISH"),],[Button.url("مطـور السـورس", "https://t.me/IC_X_K"),]]
