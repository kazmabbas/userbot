...
- تخمـط صيـر هقــر كفــوو واذكــر المصــدر
"""
...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت القائد"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ ✘𓆩𝗠𝗔𝗥𝗢𖠲𓆪 ™ ─┄─┄─┄─⋆"
zed_dev = (6650021309, 5593884330)
zel_dev = (6650021309, 5578760481)
zelzal = (6294853381, 5904390523)
...
# الـرتب الوهميـه & البريميـوم كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    if user_id in zelzal: # code by t.me/zzzzl1l
        rotbat = "⌁ هقــر السـورس 𓄂𓆃 ⌁" 
    elif user_id in zel_dev:
        rotbat = "⌁ هقــر مسـاعـد 𐏕⌁" 
