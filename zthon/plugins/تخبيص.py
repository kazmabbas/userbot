    ...
    async def inline_handler(event):
        ...
        if query.startswith("جديد") and event.query.user_id == zedub.uid:
            buttons = [
                ...
                [
                    Button.inline("امطورين توفي", data="zmusic"),
                ],
            ]
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامر جديده🎸](t.me/Repethone) .\n\n**⎉اليك عزيزي الاوامر الجديده :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامر جايه 🎸](t.me/Repethone) .
**- الامـر :**
**⪼** `.سينزر تاج راسك`
