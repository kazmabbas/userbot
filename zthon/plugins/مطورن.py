...
async def amireallyalive(event):
    ...
    CAT_IMG = " https://graph.org/file/6e4359dc87a11152d5951.jpg "
    if CAT_IMG:
        CAT = [x for x in CAT_IMG.split()]
        A_IMG = list(CAT)
        PIC = random.choice(A_IMG)
        cat_caption = f"مطورين ريفز\n"
        cat_caption += f"✛━━━━━━━━━━━━━✛\n"
        cat_caption += f"- المطور  : @IC_X_K\n"
        cat_caption += f"- المطور  : @Q_2_Q_Y\n"
        cat_caption += f"✛━━━━━━━━━━━━━✛\n"
...
progs = [6301863282, 6301863282, 6301863282, 5838360982]
