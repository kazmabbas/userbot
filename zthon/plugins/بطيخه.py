...
games = {}
aki_photo = "https://graph.org/file/ee41920d277e61f3310d6.jpg"


@zedub.zed_cmd(pattern="بطيخه(?:\s|$)([\s\S]*)")
async def rozdo(e):
...
async def daj(e):
    ...
    try:
        ...
        return await e.answer("احلا بطيخه", alert=True)
    ...
    if (
        ...
        ans = [
            await e.builder.photo(
                aki_photo,
                text=query,
                buttons=[Button.inline("⎉ انت مش مطور انت بطيخه⎉", data=e.text)],
            )
        ]
        await e.answer(ans)
