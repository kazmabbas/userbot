...
حقـوق للتـاريخ : @Repethone
@EEc5e - كتـابـة الملـف : توفي العامري"""
...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/Repethon) 𓆪\n\n"
    "**⎉╎قائـمه اوامر تغييـر فـارات الصـور بأمـر واحـد فقـط - لـ اول مـره ع سـورس ريبيثون يوزر بـوت 🦾 :** \n\n"
    ...
    "\n𓆩 [𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/Repethon) 𓆪"
)
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if variable in heroku_var:
            await zed.edit("**⎉╎تم تغييـر {} بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n**⎉╎يتم الان اعـادة تشغيـل بـوت ريبيثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        else:
            await zed.edit("**⎉╎تم اضافـة {} بنجـاح ☑️** \n**⎉╎المضاف اليه :**\n `{}` \n**⎉╎يتم الان اعـادة تشغيـل بـوت ريبيثون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
