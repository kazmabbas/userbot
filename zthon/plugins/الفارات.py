# ⧛ 𝚂૯ท𝚉เ𝚁 ׀ 🚸⊀𝟑⌯اݪــتأࢪيخ ׀سـيــــٌنزر׀ ⧚
...
حقـوق للتـاريخ : @IC_X_K
@IC_X_K - كتـابـة الملـف :  سينزر الهيبــه"""
# ⧛ 𝚂૯ท𝚉เ𝚁 ׀ 🚸⊀𝟑⌯اݪــتأࢪيخ ׀سـيــــٌنزر׀ ⧚
import asyncio
import math
import os
...
async def variable(event):
    ...
    viran = "Asia/Tehran"
    heroku_var = app.config()
    zed = await edit_or_reply(event, "**❈╎جـاري إعـداد المنطقـة الزمنيـة لـ تيبثـون 🌐...**")
    # All Rights Reserved for "Zed-Thon" "زلـزال الهيبـه"
