...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐑𝐄𝐅𝐙 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/VARS_REFZ) 𓆪\n\n"
    ...
    "\n𓆩 [ 𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/VARS_REFZ) 𓆪"
)
...
async def variable(event):
    ...
    viran = "Asia/Tehran"
    heroku_var = app.config()
    zed = await edit_or_reply(event, "**❈╎جـاري أعـداد المنطقـه الزمنيـة لـ ريفز 🌐...**")
    # All Rights Reserved for "Zed-Thon" "زلـزال الهيبـه"
