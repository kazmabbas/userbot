#𝙎𓏺𝞝𝙉𝙕𝙄𝙍 ®
#الملـف حقـوق وكتابـة سينزر الهيبـه ⤶ @def_Zoka خاص بسـورس ⤶ 𝙎𓏺𝞝𝙉𝙕𝙄𝙍
...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            ...
            caption=f"**🎆┊حـالات واتـس قصيـرة 🧸♥️**\n\n[➧𝙎𝙊𝙐𝙍𝘾𝙀 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘](https://t.me/Repethone)",
        )
...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            event.chat_id,
            file=random.choice(zedph),
            caption=f"**🎆┊صـورة ومعلومـة ➧ 🛤💡◟**\n\n[➧??𝙤𝙪𝙧𝙘𝙚 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘](https://t.me/Repethone)",
        )
        await zzevent.delete()
    except Exception:
        await zzevent.edit("**╮•⎚ عذرًا .. لـم استطـع ايجـاد المطلـوب ☹️💔**")
