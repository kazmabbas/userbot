...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 ✘𓆩𝗠𝗔𝗥𝗢𖠲𓆪  - بوت تحميل الافلام والمسلسلات من اليوتيوب](t.me/M_4_R_0) 𓆪\n\n"
    "⪼ يوزر بوت تحميل مسلسلات وافلام من اليوتيوب\n"
    "⪼ 𓅱 𝐔𝐒𝐄𝐑 @ledaer_DWN_BOT\n"
    "\n𓆩 [𐇮 ™✘𓆩𝗠𝗔𝗥𝗢𖠲𓆪  • 𐇮](t.me/M_4_R_0) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت مارو انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت مارو انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
