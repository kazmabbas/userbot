...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗟𝗲𝗔𝗱𝗘𝗿𓅯 - بوت تحميل الافلام والمسلسلات من اليوتيوب](t.me/def_Zoka) 𓆪\n\n"
    "⪼ يوزر بوت تحميل مسلسلات وافلام من اليوتيوب\n"
    "⪼ 𓅱 𝐔𝐒𝐄𝐑 @@ledaer_DWN_BOT\n"
    "\n𓆩 [𐇮 𝙈𝙊𝙉𝙕𝙀𝙍™𝗹𝗲𝗮𝗱𝗲𝗿 • 𐇮](t.me/Z_X_Z_B) 𓆪"
    "\n𓆩 [𐇮𓅱 •𝑬3𝒅𝑨𝒎• 𝙇𝙚𝘼𝙙𝙀𝙧 ™⤶ 𐇮](t.me/DAD_E3DAM) 𓆪"
)
