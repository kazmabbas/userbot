...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المكالمـات والميـوزك 🎸](t.me/Repethone) .
**- الامـر :**
**⪼** `.بدء مكالمه`
**⪼** `.انهاء مكالمه`
**⪼** `.انضم`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/Repethone) .
**- الامـر :**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس ريفز
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه 🛗](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/Repethone) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/def_Zoka) .
**- الامـر :**
**⪼** `.تثبيت`
`.الغاء تثبيت`
`.الغاء تثبيت الكل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر مكـافح التكــرار 🛡](t.me/def_Zoka) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المنــع 🚫](t.me/def_Zoka) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافه والتفليـش 👾](t.me/def_Zoka) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات 🧬](t.me/def_Zoka) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الوقتــي 🕰](t.me/def_Zoka) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/def_Zoka) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/def_Zoka) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝐑𝐄𝐅𝐙 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الفحـص 🏮](t.me/def_Zoka) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات](t.me/Repethone) .
**- الامـر :**
**⪼** `.اضف فار صورة الفحص`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فـارات السـورس 🛰](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات بعـض اوامـر فـارات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه 🏂](t.me/Repethone) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التحشيش 🎃](t.me/Repethone) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳](t.me/Repethone) .
**- الامـر :**
**⪼** `.بلاي`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الحســاب 🚹](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات الاوامـر المتعلقـه بالحسـاب :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر حمـايــة الخــاص 🛡](t.me/Repethone) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فــارات حمـايــة الخــاص 🛡](t.me/Repethone) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المـرفقــات 🖥](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الستـوريـات 🎆🏖](t.me/Repethone) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/Repethone) .
**- الامـر :**
**⪼** `.بنات`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الادوات 💡](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات الروابــط 💡](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/Repethone) .
**- الامـر :**
...
تـاريـخ كتابـة الملـف - 2023/12/12
 https://t.me/Repethone/18
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & التشيكـر ❇️](t.me/Repethone) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميـع النقـاط 💡](t.me/Repethone) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/Repethone) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗥𝗘𝗣𝗘𝗧𝗛𝗢𝗡𝗘 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر النشــر التلقــائي 🌐](t.me/Repethone  ) .
**- الامـر :**
**⪼** `.تلقائي`
