    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس القائد الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗦َِ𝗼َِ𝗨َِ𝗿َِ𝗖َِ𝗲 َِ𝗟𝗘𝗮𝗗𝗲𝗥", "https://t.me/V_P_N_8"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "leader")
...
zthon = {"@V_P_N_8", "@POSTS_E3DAM", "@SOURCEE_X", "@Help_Tele_Leader", "@Help_Leader", "@leader_VIAS"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/mo.jpg")

        _, groupid = await create_supergroup(

            "كـروب السجـل القائد", zedub, Config.TG_BOT_USERNAME, descript, photozed
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/mo2.jpg")
