    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس مارو الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url(" سورس مارو 𝙎𝙊𝙐𝙍𝘾𝙀 𝙈𝘼𝙍𝙊", "https://t.me/M_4_R_0"),)],
...
zthon = {"@M_4_R_0", "@MA_99O", "@SOURCEE_X", "@Help_Tele_Leader", "@Help_Leader", "@leader_VIAS"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "كـروب السجـل مارو", zedub, Config.TG_BOT_USERNAME, descript, photozed
