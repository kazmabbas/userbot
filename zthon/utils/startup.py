    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/86bf453aec7e5cd4e6fb8.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس ريفز الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝐬𝐨𝐮𝐫𝐜𝐞 𝐑𝐄𝐅𝐙", "https://t.me/def_Zoka"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "def_Zoka")
...
zthon = {"@def_Zoka", "@VARS_REFZ", "@source_refzz", "@zoUka", "rev_fxx"}
async def saves():
